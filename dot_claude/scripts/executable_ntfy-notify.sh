...
#
# Usage:
#   ntfy-notify.sh notification    # reads hook JSON from stdin
#   ntfy-notify.sh stop            # posts task-completion for current repo
#   ntfy-notify.sh subagent-stop   # posts subagent-completion
#
...
case "${mode}" in
    ...
    subagent-stop)
        ...
        ;;
    *)
        echo "usage: $0 {notification|stop|subagent-stop}" >&2
        exit 2
        ;;
esac
